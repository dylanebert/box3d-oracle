...
const scenarioRoster = [...foundationRoster, ...jointsRoster, ...surfacesRoster, ...compoundSensorRoster];
...
if (!scenarioAdapter.includes("SCENARIO_MESH_RESOURCE") || !scenarioAdapter.includes("SCENARIO_HEIGHT_RESOURCE") || !scenarioAdapter.includes("SCENARIO_COMPOUND_RESOURCE") || !scenarioAdapter.includes("SCENARIO_SENSOR_EVENTS") || !scenarioAdapter.includes("isBullet")) throw new Error("surface and compound-sensor commands are not interpreted");
